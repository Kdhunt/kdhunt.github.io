(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[67],{"+dCS":function(e,o,c){"use strict"
c.d(o,"a",(function(){return r}))
var t=c("ouhR")
var l=c.n(t)
class r{constructor(e){this.minToolHeight=e||450}tool_content_wrapper(e){let o=l()(`div[data-tool-wrapper-id*='${e}']`)
...
c.d(o,"ignorelist",(function(){return l}))
const t=["requestFullWindowLaunch","lti.resourceImported"]
const l=["LtiDeepLinkingResponse"]},"4bdt":function(e,o,c){"use strict"
var t=c("pQTu")
var l=c("m0r6")
...
return o}(p)},"9cv0":function(e,o,c){var t={"./__tests__/handleLtiPostMessages.test.js":["Af1U",752],"./__tests__/lti.resourceImported.test.js":["yySz",692],"./__tests__/requestFullWindowLaunch.test.js":["w8Zi",693],"./handleLtiPostMessage.js":["y+46"],"./lti.resourceImported.js":["75OS",753],"./messageTypes.js":["0YqI"],"./requestFullWindowLaunch.js":["S3m7",754]}
...
const k=e?e.title:""
return Object(t["a"])(l["a"],{open:i,label:k,onDismiss:s,placement:"end",size:"regular",padding:"0",headerPadding:"medium"},void 0,Object(t["a"])("iframe",{style:{border:"none",display:"block",width:"100%",height:"100%"},"data-testid":"ltiIframe",src:p,title:k,"data-lti-launch":"true"}))}},MdYG:function(e,o,c){"use strict"
...
var c=o.height
c<=0&&(c=1)
const a=t.tool_content_wrapper(o.token||e.origin).data("height_overridden",true)
if(a.length>0)t.resize_tool_content_wrapper(c,a)
else{const o=d(e.source)
if(o){"number"===typeof c&&(c+="px")
o.height=c
o.style.height=c}}break
case"lti.fetchWindowSize":{const c=d(e.source)
if(c){o.height=window.innerHeight
...
c.contentWindow.postMessage(e,"*")}break}case"lti.showModuleNavigation":true!==o.show&&false!==o.show||l()(".module-sequence-footer").toggle(o.show)
break
...
let n
if(t["ignorelist"].includes(l))return false
if(!t["whitelist"].includes(l)){console.error("invalid messageType: "+l)
return false}try{const e=await c("9cv0")(`./${l}.js`)
n=e.default
n(r)
return true}catch(e){console.error(`Error loading or executing message handler for "${l}"`,e)}}
o["default"]=r}}])

//# sourceMappingURL=67-c-4b8ef2c89b.js.map