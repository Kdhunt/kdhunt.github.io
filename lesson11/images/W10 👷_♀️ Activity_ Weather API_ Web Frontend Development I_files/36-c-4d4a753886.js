(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[36],{"71EO":function(e,t,i){"use strict"
...
const i=new URL(e)
const s=new URL(t)
return i.origin===s.origin}var S,D,z,w=function(e,t){return function(){return e.apply(t,arguments)}},A=function(e,t){for(var i in t)x.call(t,i)&&(e[i]=t[i])
...
D=function(){return r.a.includes(ENV.current_user_roles,"admin")}
z=function(){return r.a.includes(ENV.current_user_roles,"student")&&!S()}
...
i.prototype.inClosedGradingPeriod=function(){if(D())return false
...
i.prototype.isOnlineSubmission=function(){return r.a.some(this._submissionTypes(),(function(e){return"online"===e||"online_text_entry"===e||"media_recording"===e||"online_url"===e||"online_upload"===e}))}
...
i.prototype.htmlUrl=function(){return this.isQuizLTIAssignment()&&S()&&ENV.FLAGS&&ENV.FLAGS.new_quizzes_modules_support?this.htmlEditUrl():this.get("html_url")}
...
return i}(a["Model"])},HbFp:function(e,t,i){"use strict"
var s=i("qJBq")
var n=i.n(s)
var o=i("pQTu")
...
//# sourceMappingURL=36-c-4d4a753886.js.map